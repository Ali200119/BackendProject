    ...
    public class AppDbContext : IdentityDbContext<User>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                ...
                new Product { Id = 9, Name = "Trans-Weight Hooded Wind and Water Resistant Shell", Price = 11.90, CategoryId = 5, BrandId = 3, IsNewArrival = true, IsBestseller = true, IsFeatured = false, CreatedAt = DateTime.Now, IsSmartphone = true, StockCount = 235, Description = "Block out the haters with the fresh adidas® Originals Kaval Windbreaker Jacket. Part of the Kaval Collection. Regular fit is eased, but not sloppy, and perfect for any activity. Plain-woven jacket specifically constructed for freedom of movement." },
