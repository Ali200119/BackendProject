    ...
    public partial class initialProject : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 8, 1, 19, 46, 17, 915, DateTimeKind.Local).AddTicks(9059), "Simply dummy text of the printing and typesetting industry.Lorem Ipsum...", "blog-1.jpg", "This is First Post For XipBlog" },
                    { 2, new DateTime(2022, 8, 1, 19, 46, 17, 915, DateTimeKind.Local).AddTicks(9797), "Simply dummy text of the printing and typesetting industry.Lorem Ipsum...", "blog-2.jpg", "This is Second Post For XipBlog" },
                    { 3, new DateTime(2022, 8, 1, 19, 46, 17, 915, DateTimeKind.Local).AddTicks(9826), "Simply dummy text of the printing and typesetting industry.Lorem Ipsum...", "blog-3.jpg", "This is Third Post For XipBlog" },
                    { 4, new DateTime(2022, 8, 1, 19, 46, 17, 915, DateTimeKind.Local).AddTicks(9828), "Simply dummy text of the printing and typesetting industry.Lorem Ipsum...", "blog-4.jpg", "This is Fourth Post For XipBlog" }
                });
